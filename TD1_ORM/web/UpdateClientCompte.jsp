<%-- 
    Document   : UpdateClientCompte
    Created on : 10 oct. 2018, 16:07:00
    Author     : Ilangovane
--%>
            ...
            <div class="row">
                ...
                <article class="col-xs-12 maincontent">
                    <header class="page-header">
                        <h1 class="page-title">Ajouter un client au compte 234345345354</h1>
                    </header>
                            ...
                            <div class="panel-body">
                                ...
                                <form>
                                    <div class="top-margin">
                                        ...
                                        <input type="text" class="form-control" value="232R43234234234" disabled>
                                    </div>
                                    <div class="top-margin">
                                        <label>Libelle<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" value="Compte courant"disabled>
                                    </div>
