<%-- 
    ...
    Created on : 10 oct. 2018, 16:06:23
    Author     : Ilangovane
--%>
                            ...
                            <div class="panel-body">
                                ...
                                <form>
                                    ...
                                    <div class="top-margin">
                                        ...
                                        <input type="text" class="form-control" value="2343589347589347589347589347" disabled>
                                    </div>

                                    <div class="top-margin">
                                        <label>Solde<span class="text-danger">*</span></label>
                                        <input type="text" value="Ancien solde" class="form-control">
                                    </div>
